...
cp /tmp/artifacts/entrypoint-notebook.sh /entrypoint-notebook.sh
cp /tmp/artifacts/python.code-workspace /python.code-workspace
cp /tmp/artifacts/java.code-workspace /java.code-workspace
cp /tmp/artifacts/requirements.txt /requirements.txt
...
chown 0:0 /entrypoint-notebook.sh
chmod +x /entrypoint-notebook.sh
chown 0:0 /requirements.txt
chown 0:0 /python.code-workspace
chown 0:0 /java.code-workspace
